...
# 'open-sum-e', determines the sum of all the elements in the list
def open_sum_e():
    listsum = sum(genlist)
...
# 'open-asc-l', sorts the list in ascending order
def open_asc_l():
    genlist.sort()
...
# 'open-dsc-l', sorts the list in descending order
def open_dsc_l():
    genlist.sort()
    genlist.reverse()
